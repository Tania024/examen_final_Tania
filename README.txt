...
a persistence unit "examen_finalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examen_final/pom.xml":
...
artifact ("examen_final.war") is already built. You can build
